...
(function () {
	...
	if (typeof window !== "undefined") (window.__svelte || (window.__svelte = { v: /* @__PURE__ */ new Set() })).v.add(PUBLIC_VERSION);
	function create_fragment(ctx) {
		...
		return {
			c() {
				...
				attr(button, "class", "svelte-ux163e");
				attr(label, "class", "svelte-ux163e");
				attr(div, "class", "app svelte-ux163e");
			},
			m(target, anchor) {
